...
class ArrendatariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arrendatario" do
    assert_difference('Arrendatario.count') do
      post arrendatarios_url, params: { arrendatario: { cc: @arrendatario.cc, correo: @arrendatario.correo, email: @arrendatario.email, nombre: @arrendatario.nombre, telefono: @arrendatario.telefono } }
    end
  ...
  test "should update arrendatario" do
    patch arrendatario_url(@arrendatario), params: { arrendatario: { cc: @arrendatario.cc, correo: @arrendatario.correo, email: @arrendatario.email, nombre: @arrendatario.nombre, telefono: @arrendatario.telefono } }
